...
/**
 * Bridge component that forwards change handler requests to the order saga handler service.
 *
 * This component implements the ChangeHandler interface and acts as a bridge
 * to the OrderSagaHandler service, using the generated Restate client
 * to forward requests asynchronously.
 */
@Component
class OrderSagaChangeHandlerBridge : ChangeHandler {
    /**
     * Forward change handler request to the order saga handler service.
     *
